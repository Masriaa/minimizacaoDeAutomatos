...
int main() {
    ...
    afd.add_alphabet_symbol("a");
    afd.add_alphabet_symbol("b");

    afd.set_stater_state("q0");
    afd.add_final_state("q4");
    afd.add_final_state("q5");

    afd.add_transition("q0", "b", {"q1"});
    afd.add_transition("q0", "a", {"q2"});
    afd.add_transition("q1", "b", {"q0"});
    afd.add_transition("q1", "a", {"q1"});
    afd.add_transition("q2", "a", {"q4"});
    afd.add_transition("q2", "b", {"q5"});
    afd.add_transition("q3", "b", {"q4"});
    afd.add_transition("q3", "a", {"q5"});
    afd.add_transition("q4", "b", {"q2"});
    afd.add_transition("q4", "a", {"q3"});
    afd.add_transition("q5", "b", {"q3"});
    afd.add_transition("q5", "a", {"q2"});

    vector<string> palavras = {"", "aa", "aaba", "bbab", "bbbbbbbb", "abababababbb", "baaabaaab", "babaaaba", "bbabbaaaba"};
